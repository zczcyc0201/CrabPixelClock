#ifndef __ZCZ_SHAPE_ANIMATION
#define __ZCZ_SHAPE_ANIMATION
// See http://blog.riyas.org/2013/12/online-led-matrix-font-generator-with.html


static unsigned char PROGMEM animationClear[] = { B00000000,
    B00000000,
    B00000000,
    B00000000,
    B00000000,
    ...
    B00000000 };
//钩子动画
static unsigned char PROGMEM animationHook1[] = { B00000000,
    B00000000,
    B00000000,
    B01000000,
    B00000000,
    ...
    B00000000,
    B00000000 };
static unsigned char PROGMEM animationHook2[] = { B00000000,
    B00000000,
    B00000000,
    B01000000,
    B00100000,
    ...
    B00000000,
    B00000000 };
static unsigned char PROGMEM animationHook3[] = { B00000000,
    B00000000,
    B00000000,
    B01000100,
    B00101000,
    ...
    B00000000,
    B00000000 };
static unsigned char PROGMEM animationHook4[] = { B00000000,
    B00000001,
    B00000010,
    B01000100,
    B00101000,
    ...
    B00000000 };
//右箭头动画
static unsigned char PROGMEM animationArrow1[] = { B00000000,
    B00000000,
    B00000000,
    B01100000,
    B00000000,
    ...
    B00000000,
    B00000000 };
static unsigned char PROGMEM animationArrow2[] = { B00000000,
    B00000000,
    B00000000,
    B01111100,
    B00000000,
    ...
    B00000000,
    B00000000 };
static unsigned char PROGMEM animationArrow3[] = { B00000000,
    B00000100,
    B00000010,
    B01111111,
    B00000010,
    ...
    B00000000 };
//心跳动画
static unsigned char PROGMEM animationHeart1[] = { B00000000,
    B01100110,
    B11111111,
    B11111111,
    B11111111,
...
static unsigned char PROGMEM animationHeart2[] = { B00000000,
    B00000000,
    B00000000,
    B00100100,
    B01111110,
...
static unsigned char PROGMEM animationHeart3[] = { B00000000,
    B00000000,
    B00000000,
    B00000000,
    B00111100,
...
B01111110,
B00111100};
static unsigned char PROGMEM pacmanBean[] =
{
B00000000,
B00000000,
B00000000,
